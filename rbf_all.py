...
# Code to implement the RBF network for all seasons combined
import numpy as np
import random
import pandas as pd
...
# read the dataset
rd = pd.read_csv('C:/Users/user/Downloads/indian-premier-league-csv-dataset/data/all9seasons.csv', sep =',' , header = 0)



# split the dataset into train and test with the ratio 80:20
train, test = train_test_split(rd, test_size=0.2)
